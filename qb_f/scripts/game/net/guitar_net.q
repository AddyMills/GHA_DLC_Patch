...
script invite_accepted 
	...
	if ((($is_network_game = 0) && ($playing_song)) &&
		...
		create_popup_warning_menu {
			textblock = {
				text = "Quitter cette session de jeu ? Seul le joueur qui a accepté l'invitation à un jeu peut aller sur Xbox LIVE."
				pos = (640.0, 380.0)
			}
...
script create_link_unplugged_dialog 
	...
	create_popup_warning_menu \{title = "CONNEXION PERDUE"
		title_props = {
			scale = 1.0
		}
		textblock = {
