info_text = [
	...
	"Va jeter un oeil sur les derniers téléchargements Guitar Hero 3 disponibles !"
	"Sois un Guitar Hero et rejoins la communauté en ligne !"
...
script create_online_main_menu \{menu_title_xenon = "Xbox LIVE"
	...
	if isxenon
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTIE RAPIDE : MATCHMAKING D'AMIS"
			info_text_index = 0
			pad_choose_script = online_menu_select_quickmatch_player
		}
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTIE RAPIDE : PARTIE AVEC CLASSEMENT"
			info_text_index = 1
