info_text = [
	...
	"Accedi all'elenco degli ultimi download disponibili per Guitar Hero 3."
	"Dimostra di essere un vero Guitar Hero e unisciti alla comunità online!"
...
script create_online_main_menu \{menu_title_xenon = "Xbox LIVE"
	...
	if isxenon
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTITA VELOCE: PARTITA DEL GIOCATORE"
			info_text_index = 0
			pad_choose_script = online_menu_select_quickmatch_player
		}
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTITA VELOCE: PARTITA CLASSIFICATA"
			info_text_index = 1
