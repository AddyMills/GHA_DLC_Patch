...
script invite_accepted 
	...
	if ((($is_network_game = 0) && ($playing_song)) &&
		...
		create_popup_warning_menu {
			textblock = {
				text = "Abbandonare la sessione di gioco? Solo il giocatore che ha accettato l'invito ad un gioco passerà a Xbox LIVE."
				pos = (640.0, 380.0)
			}
...
script create_link_unplugged_dialog 
	...
	create_popup_warning_menu \{title = "CONNESSIONE PERSA"
		title_props = {
			scale = 1.0
		}
		textblock = {
