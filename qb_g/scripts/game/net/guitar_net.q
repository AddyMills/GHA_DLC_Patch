...
script invite_accepted 
	...
	if ((($is_network_game = 0) && ($playing_song)) &&
		...
		create_popup_warning_menu {
			textblock = {
				text = "Bist Du sicher, dass Du dieses Spiel verlassen möchten? Nur der Spieler, der die Spieleinladung angenommen hat, wird mit Xbox LIVE verbunden."
				pos = (640.0, 380.0)
			}
...
script create_link_unplugged_dialog 
	...
	create_popup_warning_menu \{title = "VERBINDUNG UNTERBROCHEN"
		title_props = {
			scale = 1.0
		}
		textblock = {
