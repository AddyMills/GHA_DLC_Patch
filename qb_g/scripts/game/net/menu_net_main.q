info_text = [
	...
	"Zieh Dir die neuesten verfügbaren Downloads für Guitar Hero 3 rein."
	"Sei ein Gitarrenheld und tritt der Online-Community bei!"
...
script create_online_main_menu \{menu_title_xenon = "Xbox LIVE"
	...
	if isxenon
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "SCHNELLES SPIEL: MITSPIELER-SUCHE"
			info_text_index = 0
			pad_choose_script = online_menu_select_quickmatch_player
		}
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "SCHNELLES SPIEL: RANGLISTEN-SPIEL"
			info_text_index = 1
