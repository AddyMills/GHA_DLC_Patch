info_text = [
	...
	"Consulta las últimas descargas disponibles para Guitar Hero 3."
	"¡Conviértete en un Guitar Hero y únete a la comunidad online!"
...
script create_online_main_menu \{menu_title_xenon = "Xbox LIVE"
	...
	if isxenon
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTIDA RÁPIDA: PARTIDA DE JUGADOR"
			info_text_index = 0
			pad_choose_script = online_menu_select_quickmatch_player
		}
		net_add_item_to_main_menu {
			vmenu = <vmenu_id>
			text = "PARTIDA RÁPIDA: PARTIDA IGUALADA"
			info_text_index = 1
