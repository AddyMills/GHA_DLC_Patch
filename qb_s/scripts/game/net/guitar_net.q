...
script invite_accepted 
	...
	if ((($is_network_game = 0) && ($playing_song)) &&
		...
		create_popup_warning_menu {
			textblock = {
				text = "¿Seguro que quieres salir de esta sesión? Sólo accederá a Xbox LIVE el jugador que acepte la invitación."
				pos = (640.0, 380.0)
			}
...
script create_link_unplugged_dialog 
	...
	create_popup_warning_menu \{title = "SE HA PERDIDO LA CONEXIÓN"
		title_props = {
			scale = 1.0
		}
		textblock = {
